    ...
    return (
        <header className='sticky top-0 p-5 flex items-start justify-between max-w-6xl mx-auto z-20 xl:items-center'>
            ...
            <motion.div initial={{ x: -500, opacity: 0, scale: 0.5 }} animate={{ x: 0, opacity: 1, scale: 1 }} transition={transition} className='flex flex-row items-center'>
                <SocialIcon className='hover:bg-[#F7AB0A]/40 rounded-full' url="https://www.linkedin.com/in/muhammad-aiman-abdul-aziz-181b76110/" bgColor="transparent" fgColor="#aeaeae" style={{ height: 50, width: 50 }} />
                <SocialIcon className='hover:bg-[#F7AB0A]/40 rounded-full' url="https://github.com/aimanaziz1993" bgColor="transparent" fgColor="#aeaeae" style={{ height: 50, width: 50 }} />
            </motion.div>
            ...
            <motion.div initial={{ x: 500, opacity: 0, scale: 0.5 }} animate={{ x: 0, opacity: 1, scale: 1 }} transition={transition} className='cursor-pointer'>
                <SocialIcon className='hover:bg-[#F7AB0A]/40 rounded-full' network='email' bgColor="transparent" fgColor="#aeaeae" style={{ height: 50, width: 50 }} />
